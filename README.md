...
Откройте [http://localhost:6969](http://localhost:6969). В первом списке укажите имена, а во втором — то, что нужно между ними поделить. Можно крутить колесо вручную либо запустить автоматический выбор для всех. Готовый результат можно экспортировать в CSV.
